...
func init() {
	...
	ginbinCmd.Flags().StringVarP(&flagTags, "tags", "t", "", "The destination path of the generated package.")
	...
	ginbinCmd.Flags().BoolVarP(&flagNoCompress, "zip", "z", false, "Ignore modification times on files.")
	ginbinCmd.Flags().BoolVarP(&flagNoMtime, "mtime", "m", false, "Do not use compression to shrink the files.")
